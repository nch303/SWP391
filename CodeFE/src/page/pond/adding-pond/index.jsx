...
function AddPond() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await api.post("pond/create", pond);
    ...
    <form className="pond-form" onSubmit={handleSubmit}>
      ...
      <label>
        ...
        <input
          ...
          name="drainCount"
          value={drainCount}
          onChange={(e) => setDrainCount(e.target.valueAsNumber)}
        />
      </label>
      <br />
      <label>
        ...
        <input
          ...
          name="skimmerCount"
          value={skimmerCount}
          onChange={(e) => setSkimmerCount(e.target.valueAsNumber)}
        />
      </label>
      <br />
      <label>
        ...
        <input
          ...
          value={pumpingCapacity}
          onChange={(e) => setPumpingCapacity(e.target.valueAsNumber)}
        />
      </label>
      <br />
